...
const RPMessage = ({ points }: Props) => {
  if (points >= 0 && points <= 18) {
    return (
      <Screen 
        title="Realización Personal: BAJO"
        body={

          <div className="text-justify">
        <p className="my-4">La sub-escala Realización Personal evalúa los sentimientos de autoeficacia y realización personal en el trabajo. Describe los sentimientos de competencia y percepción de factores de éxito laboral.</p>
        <p>Su resultado es BAJO. Esto indica que no hay presencia de indicadores negativos en esta área. Reflexione sobre cómo se percibe a nivel profesional, en el tiempo actual y nivel futuro para tener clara una valoración sobre cómo evoluciona su autorrealización profesional.</p>
      </div>
        }
      />
    );
    ...
    return (
      <Screen 
        title="Realización Personal: MEDIO"
        body={
          <div className="text-justify">
        <p className="my-4">La sub-escala Realización Personal evalúa los sentimientos de autoeficacia y realización personal en el trabajo. Describe los sentimientos de competencia y percepción de factores de éxito laboral.</p>
