  ...
  return (
    <div className="navbar bg-base-100 mt-6">
      ...
      <div className="flex-none">
        ...
        {/* ----------- Profile Picture -----------  */}
        <div className="dropdown dropdown-end lg:flex lg:items-center">
          <div tabIndex={0} className="btn btn-ghost btn-circle avatar shadow-md">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact dropdown-content mt-60 p-2 shadow bg-base-100 rounded-box w-52"
          >
            <li>
